package dev.gaphunter.awssdkclientreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.awssdkclientreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.awssdkclientreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "AWS SDK Client Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33806-aws-sdk-client-reuse-companion/reviews"
